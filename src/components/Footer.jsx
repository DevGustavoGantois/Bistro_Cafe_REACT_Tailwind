...
const Footer = () => {
  ...
  return (
    <footer className='relative top-96 z-20 bg-dark lg:min-h-[620px] lg:bg-footer lg:bg-center lg:bg-no-repeat pt-20 lg:pt-32' id='contato'>
       <div className="container mx-auto h-full">
          <motion.div variants={staggerContainer} initial='hidden' whileInView={'show'} className='h-full flex flex-col gap-y-4'>
            ...
            <motion.div variants={fadeIn('up', 'tween', 0.6, 1.6)} className='flex flex-col lg:flex-row gap-x-[130px] gap-y-12 lg:gap-y-0 lg:mb-12'>
